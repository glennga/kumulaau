...
\begin{tikzpicture}
    ...
    ylabel={$\propto$ Likelihood}, ymax=0.3,
    ...
    \node[black, below] at (axis cs:2.85,0.075){\small{$1$}};
    \node[black, below] at (axis cs:3.85,0.165){\small{$2$}};

    \addplot+[very thick, black, dashed] coordinates {(3.5, 0.16131382) (3.5, 0.25158882) (4.5, 0.25158882)};
    \node[black, below] at (axis cs:4.85,0.255){\small{$3$}};

    \addplot+[very thick, red, dashed] coordinates {(4.5, 0.25158882) (4.0, 0.25158882) (4.0, 0.21296534)};
    \node[red, below] at (axis cs:4.35,0.225){\small{$4$}};
